            ...
            <div className="flex items-center space-x-2">
              <Checkbox
                ...
                onCheckedChange={(checked) =>
                  handleCheckboxChange("hasInvitation", checked as boolean)
                }
              />
            ...
            <div className="space-y-4">
              ...
              {formData.hasInvitation && (
                <div className="space-y-2">
                  ...
                  <FileUpload
                    onFileChange={(file) =>
                      handleFileChange("invitation", file)
                    }
                    accept="image/*,.pdf"
                  />
                </div>
