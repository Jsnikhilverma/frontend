...
export function PassportForm({ onSubmit }: { onSubmit: () => void }) {
  ...
  return (
    <div className="flex flex-col ml-78 items-center justify-center min-h-screen">
      <h1 className="text-3xl font-bold mb-6">Passport Submission</h1>
      <Card>
        <CardHeader>
          <CardTitle>Passport Details</CardTitle>
          <CardDescription>
            Please provide your passport details and upload images of both sides
          </CardDescription>
        </CardHeader>
        <form onSubmit={handleSubmit}>
          <CardContent className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <FileUpload
                  onFileChange={(file) =>
                    handleFileChange("passportFront", file)
                  }
                  accept="image/*"
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <FileUpload
                  onFileChange={(file) =>
                    handleFileChange("passportBack", file)
                  }
                  accept="image/*"
                />
              </div>
          ...
          <CardFooter>
            <Button
              type="submit"
              className="w-full bg-gray-900 text-yellow-500 hover:bg-gray-800 mt-4"
              variant="outline"
            >
