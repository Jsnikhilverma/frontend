...
export function PassportPending() {
  ...
  useEffect(() => {
    // Set passport status to approved on every page load
            ...
            {status === "pending" ? (
              <>
                ...
                <h2 className="text-xl font-medium mb-2">
                  Your passport details are under review
                </h2>
                <p className="text-muted-foreground text-center max-w-md">
                  We are currently reviewing your passport details. This process
              ...
              <>
                ...
                <p className="text-muted-foreground text-center max-w-md mb-6">
                  Congratulations! Your passport verification is complete. You
                  can now proceed to the visa application.
                </p>
                <Button
