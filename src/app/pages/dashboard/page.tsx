  ...
  return (
    <div>
      <SidebarProvider>
        ...
        <SidebarInset>
          <div className="flex flex-col min-h-screen lg:ml-32">
            {/* Wrap the Header component in a responsive container */}
            <div className="w-full">
              <Header />
            </div>
            <main className="flex-1 p-4 md:p-6 lg:ml-32">
              <div className="mb-6 md:mb-8">
                <h1 className="text-xl md:text-2xl font-bold tracking-tight">
                  Welcome back, John Doe
                </h1>
                <p className="text-sm md:text-base text-muted-foreground">
                  Track your applications and manage your travel documents
                </p>
              </div>

              <div className="grid gap-4 grid-cols-1 md:grid-cols-3 mb-6 md:mb-8">
                <StatusCard
              ...
              <Tabs defaultValue="overview" className="w-full">
                <div className="overflow-x-auto pb-2">
                  <TabsList className="mb-4 flex-nowrap whitespace-nowrap">
                ...
                <TabsContent value="overview">
                  <div className="grid gap-4 grid-cols-1 md:grid-cols-2">
                    <div className="rounded-lg border p-3 md:p-4">
                      <h3 className="text-sm md:text-base font-medium mb-3 md:mb-4">
                      ...
                      <ul className="space-y-3 md:space-y-4">
                          ...
                          <li className="flex items-center justify-between">
                            <div>
                              <p className="text-sm md:text-base font-medium">
                                Visa Approval Expected
                              </p>
                              <p className="text-xs md:text-sm text-muted-foreground">
                                {applications.visa.country} -{" "}
                                {applications.visa.type}
                              </p>
                            </div>
                            <div className="text-right">
                              <p className="text-sm md:text-base font-medium">
                                {applications.visa.daysRemaining} days
                              </p>
                            </div>
                          </li>
                        )}
                        {applications.kyc.daysRemaining > 0 && (
                          <li className="flex items-center justify-between">
                            <div>
                              <p className="text-sm md:text-base font-medium">
                                KYC Verification Expected
                              </p>
                            </div>
                            <div className="text-right">
                              <p className="text-sm md:text-base font-medium">
                                {applications.kyc.daysRemaining} days
                              </p>
                            </div>
                          </li>
                        )}
                        {applications.visa.daysRemaining <= 0 &&
                          applications.kyc.daysRemaining <= 0 && (
                            <li className="text-center py-6 md:py-8 text-sm md:text-base text-muted-foreground">
                  ...
                  <div className="rounded-lg border p-4 md:p-6">
                    ...
                    {applications.passport.status === "approved" ? (
                      <div className="space-y-4">
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4">
                          <div>
                            ...
                            <p className="text-sm md:text-base font-medium">
                              {applications.passport.documentNumber}
                            </p>
                          </div>
                          <div>
                            <p className="text-xs md:text-sm text-muted-foreground">
                            ...
                            <p className="text-sm md:text-base font-medium">
                              {applications.passport.approvedDate}
                            </p>
                          </div>
                          <div>
                            <p className="text-xs md:text-sm text-muted-foreground">
                            ...
                            <p className="text-sm md:text-base font-medium">
                              {applications.passport.expiryDate}
                            </p>
                          </div>
                          <div>
                            <p className="text-xs md:text-sm text-muted-foreground">
                      ...
                      <div className="py-6 md:py-8 text-center">
                        <p className="text-sm md:text-base text-muted-foreground">
                          Your passport application is being processed. Expected
                          completion in {applications.passport.daysRemaining}{" "}
                          days.
                        </p>
                      </div>
                    )}
                    ...
                    <div className="space-y-4">
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm md:text-base font-medium capitalize">
                            {applications.kyc.status.replace("-", " ")}
                          </p>
                        </div>
                        <div>
                          <p className="text-xs md:text-sm text-muted-foreground">
      ...
      <footer className="bg-gray-900 text-white py-6 md:py-8 lg:py-12 lg:ml-56">
        <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="col-span-1 sm:col-span-2 lg:col-span-1">
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 mb-4">
                <Image
                  ...
                  width={80}
                  height={20}
                  className="h-10 sm:h-12 lg:h-16 w-16 sm:w-20 lg:w-24"
                />
          ...
          <div className="border-t border-gray-800 mt-6 md:mt-8 lg:mt-10 pt-4 md:pt-6 text-center text-gray-400 text-xs md:text-sm lg:text-base">
            <p>
