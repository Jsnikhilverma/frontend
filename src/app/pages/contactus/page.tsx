  ...
  return (
    <div>
      ...
      <div className="bg-gray-950 text-white min-h-screen">
        {/* Hero Section */}
        <div className="relative bg-gradient-to-br from-yellow-900 via-black to-gray-900 py-20 px-6 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-yellow-400">
            Contact AXE VISA
          </h1>
          <p className="mt-4 text-lg md:text-xl text-gray-300 max-w-2xl mx-auto">
            Premium visa consultancy for travelers, students, and professionals.
            We make your visa process smooth and luxurious.
          </p>
        </div>
        ...
        <div className="max-w-6xl mx-auto py-16 px-6 grid md:grid-cols-2 gap-12">
          ...
          <div className="space-y-10">
            ...
            <p className="text-gray-400">
              Reach out to us via phone, email, or visit our office. We respond
              within 24 hours.
            </p>
            ...
            <div className="space-y-6 text-gray-300">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p>AXE VISA Pvt. Ltd., Connaught Place, New Delhi, India</p>
                </div>
              </div>
            </div>
          </div>
          ...
          {/* Contact Form */}
          <div className="bg-gray-900 p-8 rounded-2xl shadow-2xl border border-yellow-700">
            ...
            <form className="space-y-5">
              <input
                ...
                className="w-full bg-transparent border border-gray-700 rounded-xl px-4 py-3 placeholder-gray-400 focus:outline-none focus:border-yellow-500 transition"
              />
              <input
                type="email"
      ...
      <div className="bg-gray-800 py-12 text-center text-gray-400">
        <p className="text-lg">⭐ “AXE VISA made my Canada visa process effortless!” — Aayush, Delhi</p>
      </div>
      */}
      </div>
      {/* Footer */}
